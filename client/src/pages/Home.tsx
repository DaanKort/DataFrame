...
export default function Home() {
  ...
  // const vallisCycle = useSelector<IVallisCycle, any>(
  //   state => state.vallisCycle
  // );
  ...
  const user = useSelector<IUser, any>(state => state.payload);
  ...
  // console.log("Invasions: ", invasionsData);
  console.log(user);
