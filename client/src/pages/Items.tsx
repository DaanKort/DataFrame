  ...
  return (
    <>
      ...
      <ul className='hex-grid'>
        <li className='hex'>
          <Link className='hex__inner' to='/frames'>
            <img className='hex__image' src={Wallpaper1} alt='' />
            <h5 className='hex__title'>Frames</h5>
            <p className='hex__text'>The frames of war. Machines of power. All with different abilities.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>The Tenno's arsenal is massive. See what weapons the can wield.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>Upgrade your warframe, weapon or companion to make them even more powerfull.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>Upgrade your warframe with powerfull arcanes. But can you defeat the Hydrolyst to get them?</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>When a threat looms in outerspace. Archwing and its weapons will provide all the firepower to wreak havoc.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>All things must be built. But they require certain elements from different worlds.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>In need of anything more powerfull to improve your strength? Check out how and where.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>These hold the power to the ancient orokin arsenal of the tenno. Primes.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>We all know fashionframe is the endgame. See how you can customize to look like a chomp.</p>
          </Link>
        </li>
        <li className='hex'>
          <Link className='hex__inner' to='#'>
            ...
            <p className='hex__text'>Checkout all other items that haven't been mentioned before.</p>
          </Link>
        </li>
      </ul>
    </>
