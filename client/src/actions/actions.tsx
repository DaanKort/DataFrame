...
export const REQUEST_CETUS_CYCLE_DATA_FAILED =
  "REQUEST_CETUS_CYCLE_DATA_FAILED";
...
export const REQUEST_VALLIS_CYCLE_DATA_FAILED =
  "REQUEST_VALLIS_CYCLE_DATA_FAILED";
...
export const requestFrameDataFailed = () => ({
  type: REQUEST_FRAME_DATA_FAILED
});
export const receiveFrameData = (frames: any) => ({
  type: RECEIVED_FRAME_DATA,
  payload: frames
});

export const requestWeaponData = () => ({ type: REQUEST_WEAPON_DATA });
export const requestWeaponDataFailed = () => ({
  type: REQUEST_WEAPON_DATA_FAILED
});
export const receiveWeaponData = (weapons: any) => ({
  type: RECEIVED_WEAPON_DATA,
  payload: weapons
});

export const requestNews = () => ({ type: REQUEST_NEWS_DATA });
export const requestNewsFailed = () => ({ type: REQUEST_NEWS_DATA_FAILED });
export const receivedNews = (news: any) => ({
  type: RECEIVED_NEWS_DATA,
  payload: news
});

export const requestMods = () => ({ type: REQUEST_MOD_DATA });
export const requestModsFailed = () => ({ type: REQUEST_MOD_DATA_FAILED });
export const receivedMods = (items: any) => ({
  type: RECEIVED_MOD_DATA,
  payload: items
});

export const requestArcanes = () => ({ type: REQUEST_ARCANE_DATA });
export const requestArcanesFailed = () => ({
  type: REQUEST_ARCANE_DATA_FAILED
});
export const receivedArcanes = (items: any) => ({
  type: RECEIVED_ARCANE_DATA,
  payload: items
});

export const requestResources = () => ({ type: REQUEST_RESOURCE_DATA });
export const requestResourcesFailed = () => ({
  type: REQUEST_RESOURCE_DATA_FAILED
});
export const receivedResources = (items: any) => ({
  type: RECEIVED_RESOURCE_DATA,
  payload: items
});

export const requestCetusCycle = () => ({ type: REQUEST_CETUS_CYCLE_DATA });
export const requestCetusCycleFailed = () => ({
  type: REQUEST_CETUS_CYCLE_DATA_FAILED
});
export const receiveCetusCycle = (cetusCycle: any) => ({
  type: RECEIVED_CETUS_CYCLE_DATA,
  payload: cetusCycle
});

export const requestVallisCycle = () => ({ type: REQUEST_VALLIS_CYCLE_DATA });
export const requestVallisCycleFailed = () => ({
  type: REQUEST_VALLIS_CYCLE_DATA_FAILED
});
export const receiveVallisCycle = (vallisCycle: any) => ({
  type: RECEIVED_VALLIS_CYCLE_DATA,
  payload: vallisCycle
});

export const requestAlerts = () => ({ type: REQUEST_ALERTS_DATA });
export const requestAlertsFailed = () => ({ type: REQUEST_ALERTS_DATA_FAILED });
export const receiveAlerts = (alerts: any) => ({
  type: RECEIVED_ALERTS_DATA,
  payload: alerts
});
...
export const receiveDeals = (deals: any) => ({
  type: RECEIVED_DEALS_DATA,
  payload: deals
});

export const requestFissures = () => ({ type: REQUEST_FISSURE_DATA });
export const requestFissuresFailed = () => ({
  type: REQUEST_FISSURE_DATA_FAILED
});
export const receiveFissures = (fissures: any) => ({
  type: RECEIVED_FISSURE_DATA,
  payload: fissures
});

export const requestSorties = () => ({ type: REQUEST_SORTIE_DATA });
export const requesSortiesFailed = () => ({ type: REQUEST_SORTIE_DATA_FAILED });
export const receiveSorties = (sorties: any) => ({
  type: RECEIVED_SORTIE_DATA,
  payload: sorties
});

export const requestInvasions = () => ({ type: REQUEST_INVASIONS_DATA });
export const requesInvasionsFailed = () => ({
  type: REQUEST_INVASIONS_DATA_FAILED
});
export const receiveInvasions = (invasions: any) => ({
